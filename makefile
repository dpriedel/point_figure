...
CFG_INC=-I/extra/boost/boost-1.54_gcc-4.8/ -I/extra/gcc/decNumber -I/home/dpriedel/projects/workspace/app_framework/include/
CFG_LIB=-liberty -L/extra/boost/boost-1.54_gcc-4.8/lib -lboost_system-d -lboost_filesystem-d -lboost_program_options-d
RPATH_LIB=-Xlinker -rpath -Xlinker /extra/gcc/gcc-4.8/lib64 -Xlinker -rpath -Xlinker /extra/boost/boost-1.54_gcc-4.8/lib
CFG_OBJ=
OBJ=$(OUTDIR)/collect_p_f_data.o $(OUTDIR)/CApplication.o $(OUTDIR)/ErrorHandler.o $(OUTDIR)/TException.o \
	...
	$(OUTDIR)/p_f_data.o $(OUTDIR)/p_f_column.o
...
# Pattern rules
# $(OUTDIR)/%.o : ./src/%.cpp 
$(OUTDIR)/p_f_column.o : ./src/p_f_column.cpp ./src/p_f_column.h 
	$(COMPILE)

$(OUTDIR)/p_f_data.o : ./src/p_f_data.cpp ./src/p_f_data.h ./src/DDecimal_16.h 
	$(COMPILE)
