...
DROP TYPE IF EXISTS test_point_and_figure.DIRECTION CASCADE;
CREATE TYPE test_point_and_figure.direction AS ENUM ('e_unknown', 'e_up', 'e_down');

DROP TYPE IF EXISTS test_point_and_figure.BOXTYPE CASCADE;
CREATE TYPE test_point_and_figure.boxtype AS ENUM ('e_fractional', 'e_integral');

DROP TYPE IF EXISTS test_point_and_figure.BOXSCALE CASCADE;
CREATE TYPE test_point_and_figure.boxscale AS ENUM ('e_linear', 'e_percent');
