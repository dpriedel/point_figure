...
public:
    ...
    std::vector<PriceDataRecord> GetMostRecentTickerData(const std::string& symbol, date::year_month_day start_from, int how_many_previous, const US_MarketHolidays* holidays=nullptr);
