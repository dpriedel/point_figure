...
DDecQuad::DDecQuad() : decimal_{}
{
    DDecQuad::InitContext();
    decQuadZero(&this->decimal_);
}

DDecQuad::DDecQuad(const DDecQuad &rhs) : decimal_{}
{
    DDecQuad::InitContext();
    decQuadZero(&this->decimal_);
...
DDecQuad::DDecQuad(DDecQuad &&rhs) noexcept : decimal_{}
{
    DDecQuad::InitContext();
    decQuadZero(&this->decimal_);
    decQuadCopy(&this->decimal_, &rhs.decimal_);
...
DDecQuad::DDecQuad(const char *number) : decimal_{}
{
    DDecQuad::InitContext();
    decQuadZero(&this->decimal_);
...
DDecQuad::DDecQuad(const std::string &number) : decimal_{}
{
    DDecQuad::InitContext();
    decQuadZero(&this->decimal_);
...
DDecQuad::DDecQuad(std::string_view number) : DDecQuad{std::string{number}}
{
}

DDecQuad::DDecQuad(int32_t number) : decimal_{}
{
    DDecQuad::InitContext();
    decQuadZero(&this->decimal_);
...
DDecQuad::DDecQuad(uint32_t number) : decimal_{}
{
    DDecQuad::InitContext();
    decQuadZero(&this->decimal_);
...
DDecQuad::DDecQuad(const decNumber &number) : decimal_{}
{
    DDecQuad::InitContext();
    decQuadZero(&this->decimal_);
...
DDecQuad::DDecQuad(double number) : decimal_{}
{
