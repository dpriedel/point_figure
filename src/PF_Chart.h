...
public:
    ...
    [[nodiscard]] const PF_Column &front() const
    {
        return (*this)[0];
    }
    [[nodiscard]] const PF_Column &back() const
    {
    ...
    {
        return columns_.empty() && current_column_.IsEmpty();
    }
    [[nodiscard]] decimal::Decimal GetChartBoxSize() const
    {
        return boxes_.GetBoxSize();
    }
    [[nodiscard]] decimal::Decimal GetFNameBoxSize() const
    {
        return fname_box_size_;
    }
    [[nodiscard]] int32_t GetReversalboxes() const
    {
        return current_column_.GetReversalboxes();
    }
    [[nodiscard]] BoxScale GetBoxScale() const
    {
        return boxes_.GetBoxScale();
    }
    [[nodiscard]] BoxType GetBoxType() const
    {
        return boxes_.GetBoxType();
    }
    [[nodiscard]] std::string GetSymbol() const
    {
        return symbol_;
    }
    [[nodiscard]] std::string GetChartBaseName() const
    {
        return chart_base_name_;
    }
    ...
    [[nodiscard]] bool LastChangeWasReversal() const
    {
        return last_change_was_reversal_;
    }

    // for Python

    [[nodiscard]] const PF_Column &GetColumn(size_t which) const
    {
        return (*this)[which];
    }
    [[nodiscard]] PF_Column::Direction GetCurrentDirection() const
    {
    ...
    [[nodiscard]] Y_Limits GetYLimits() const
    {
        return {y_min_, y_max_};
    }

    [[nodiscard]] PF_Column::TmPt GetFirstTime() const
    {
        return first_date_;
    }
    [[nodiscard]] PF_Column::TmPt GetLastChangeTime() const
    {
        return last_change_date_;
    }
    [[nodiscard]] PF_Column::TmPt GetLastCheckedTime() const
    {
        return last_checked_date_;
    }
    ...
    {
        return boxes_.GetBoxScale() == BoxScale::e_Percent;
    }
    [[nodiscard]] bool IsFractional() const
    {
        return boxes_.GetBoxType() == BoxType::e_Fractional;
    }

    [[nodiscard]] const Boxes &GetBoxes() const
    {
        return boxes_;
    }
    [[nodiscard]] const PF_SignalList &GetSignals() const
    {
        return signals_;
    }
    ...
    [[nodiscard]] int64_t GetMaxGraphicColumns() const
    {
        return max_columns_for_graph_;
    }
    ...
    void SetMaxGraphicColumns(int64_t max_cols)
    {
        max_columns_for_graph_ = max_cols;
    }

    void AddSignal(const PF_Signal &new_sig)
    {
        signals_.push_back(new_sig);
    }
...
template <> struct std::formatter<PF_Chart::ColumnTopBottomInfo> : std::formatter<std::string>
{
